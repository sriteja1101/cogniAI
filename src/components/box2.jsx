    ...
    return(
        ...
        <div className="flex flex-col w-full gap-2 items-center">
            <div className="w-full flex justify-between items-center">
                <h2 className="text-4xl font-medium">87%</h2>
                <span className="px-3 py-2 bg-white text-gray-500 rounded-full text-xs">You're Almost There</span>
            </div>
