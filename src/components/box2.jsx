...
function Box2(){
    return(
        <div className="w-full h-[230px] bg-[#f5f7fba7] flex flex-col justify-between items-center p-3 rounded-3xl">
        ...
        <div className="flex flex-col w-full gap-2 items-center">
            ...
            <div className="flex items-center w-full gap-1 py-1.5">
                ...
                <div className="h-3.5 rounded-full bg-white"></div>
                    <span className="text-[7px] pl-0.5 text-gray-400">Verification</span>
                </div>
            </div>
