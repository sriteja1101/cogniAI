...
function Hero() {
  return (
    <div className="flex justify-center items-center">
      <div className="w-[80%] h-full max-xl:h-full pt-13 pb-5 max-lg:h-full max-md:h-full max-xl:w-[90%] max-lg:w-[95%] bg-[radial-gradient(ellipse_at_bottom,_#ffc590_0%,_#ffc590_15%,_#f0d4d9_40%,_#e0ecf9_60%,_#deeaf6_100%)] rounded-4xl flex justify-center items-center">
