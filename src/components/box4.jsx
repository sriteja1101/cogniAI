...
function Remainder({src, title, text}){
    return(
        <div className="w-full h-full rounded-2xl flex gap-2 bg-white p-2">
            {src ? <img src={src} alt={title} className="w-5"/> : <div className="self-center w-5 h-5 rounded-full border-2 border-[#80808044]"></div>}
...
function Box4(){
    return(
        <div className="w-full h-[230px] bg-[#f5f7fba7] flex flex-col justify-between gap-2 items-center p-3 rounded-3xl">
