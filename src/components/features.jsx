            ...
            <div className="w-[80%] flex flex-col items-center gap-7">
                ...
                <div className="flex items-center justify-center gap-4 w-full">
                    ...
                    <div className="w-full bg-[#FFF6EA] h-full rounded-2xl justify-center items-center flex flex-col gap-2 py-3">
                        <div className="w-[90%] h-[73%] bg-white flex flex-col gap-2 p-5 rounded-2xl mt-7 border-[20px] border-[#f2e6d766]">
                            ...
                            <div className="flex items-center rounded-2xl w-fit bg-[#f6f2f2bc] p-1 my-3">
                                <span className="bg-[#F46800] text-xs text-white px-4 py-2 rounded-2xl">News Upload</span>
                            ...
                            <div className="flex items-center flex-col w-full gap-2">
                                <div className="flex items-center justify-between gap-2 w-full bg-[#f6f2f2bc] p-2 rounded-2xl">
                                   ...
                                   <img src={internet} alt="internet" className="w-4 bg-white"/>
                                   </div>
                                    <div className="w-[80%]">
                                        <span className="text-sm font-bold">Content Refresh Alert</span>
                                        <p className="text-[10px]">Post fresh content, share insights, and stay active. Consistency is key!</p>
                                    </div>
                                   </div>
                                    <span className="text-xs text-gray-500 text-nowrap">20 MB</span>
                                </div>
                                ...
                                <div className="flex items-center justify-between gap-2 w-full bg-[#f6f2f2bc] p-2 rounded-2xl">
                                   ...
                                   <img src={internet} alt="internet" className="w-4 bg-white"/>
                                    ...
                                    <div className="w-[80%]">
                                        <span className="text-sm font-bold">Engagement Boost Reminder</span>
                                        <p className="text-[10px]">hare valuable content, post consistently, and keep your audience coming back!</p>
                                    </div>
                                   </div>
                                    <span className="text-xs text-gray-500 text-nowrap">20 MB</span>
                                </div>
                        ...
                        <div className="w-full flex flex-col gap-2 justify-center px-5">
                            ...
                            <p className="text-md text-gray-500">Al intelligently cleans, structures, and analyzes vast amounts of raw data, transforming it into meaningful insights for informed decision-making.</p>
                        </div>
                    </div>
